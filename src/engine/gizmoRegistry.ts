...
/** Which inspector section owns a gizmo; the last two are the 2D DOM hosts, which register no pickers. */
export type GizmoDomain = "objects" | "chart" | "devices" | "text" | "decorations";
