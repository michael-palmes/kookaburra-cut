  ...
  "drift-slabs": [
    {
      ...
      backing: "#e3f2fd",
      speed: 0.4,
      params: { count: 7, spread: 12, depth: 12, size: 1, drift: 1 },
    },
    {
      id: "p2",
      name: "Balmoral",
      ...
      backing: "#e5f1ff",
      speed: 0.35,
      params: { count: 5, spread: 10, depth: 14, size: 1.25, drift: 0.7 },
    },
    {
      id: "p3",
      name: "Trigg",
      ...
      backing: "#dcf5f5",
      speed: 0.45,
      params: { count: 9, spread: 14, depth: 11, size: 0.85, drift: 1.3 },
    },
    {
      id: "p4",
      name: "Burleigh",
      ...
      backing: "#f5f0dc",
      speed: 0.3,
      params: { count: 6, spread: 11, depth: 13, size: 1.1, drift: 0.9 },
    },
    {
      id: "p5",
      name: "Sorrento",
      ...
      backing: "#ffebee",
      speed: 0.5,
      params: { count: 8, spread: 13, depth: 12, size: 0.95, drift: 1.1 },
    },
    {
      id: "p6",
      name: "Painted Desert",
    ...
    },
    {
      ...
      backing: "#18100d",
      speed: 0.35,
      params: { count: 5, spread: 10, depth: 14, size: 1.3, drift: 0.7 },
    },
    {
      id: "p8",
      name: "Ellery",
      ...
      backing: "#0b1316",
      speed: 0.45,
      params: { count: 9, spread: 14, depth: 11, size: 0.85, drift: 1.2 },
    },
    {
      id: "p9",
      name: "Karlu Karlu",
  ...
  "orb-field": [
    {
      ...
      backing: "#e2f3fb",
      speed: 0.4,
      params: { count: 6, spread: 12, depth: 13, size: 1, drift: 1 },
    },
    {
      id: "p2",
      name: "Stradbroke",
      ...
      backing: "#f6f0dd",
      speed: 0.35,
      params: { count: 4, spread: 10, depth: 15, size: 1.3, drift: 0.7 },
    },
    {
      id: "p3",
      name: "Fingal",
      ...
      backing: "#ddf5ef",
      speed: 0.45,
      params: { count: 8, spread: 14, depth: 12, size: 0.8, drift: 1.3 },
    },
    {
      id: "p4",
      name: "Catseye",
      ...
      backing: "#e6f1ff",
      speed: 0.3,
      params: { count: 5, spread: 11, depth: 14, size: 1.15, drift: 0.85 },
    },
    {
      id: "p5",
      name: "Vivonne",
      ...
      backing: "#ffebf0",
      speed: 0.5,
      params: { count: 7, spread: 13, depth: 12, size: 0.9, drift: 1.1 },
    },
    {
      id: "p6",
      name: "Wolfe Creek",
    ...
    },
    {
      ...
      backing: "#18100d",
      speed: 0.35,
      params: { count: 4, spread: 10, depth: 15, size: 1.35, drift: 0.7 },
    },
    {
      id: "p8",
      name: "Tnorala",
      ...
      backing: "#0b1315",
      speed: 0.45,
      params: { count: 8, spread: 14, depth: 12, size: 0.8, drift: 1.25 },
    },
    {
      id: "p9",
      name: "Gosses Bluff",
  ...
  "halo-rings": [
    {
      ...
      backing: "#f6f0de",
      speed: 0.4,
      params: { count: 3, spread: 10, depth: 13, size: 1, tube: 0.16, drift: 1 },
    },
    {
      id: "p2",
      name: "Remarkables",
      ...
      backing: "#e4f2fe",
      speed: 0.35,
      params: { count: 2, spread: 8, depth: 14, size: 1.25, tube: 0.22, drift: 0.7 },
    },
    {
      id: "p3",
      name: "Pinnacles",
      ...
      backing: "#f4f0dc",
      speed: 0.45,
      params: { count: 4, spread: 12, depth: 12, size: 0.85, tube: 0.12, drift: 1.3 },
    },
    {
      id: "p4",
      name: "Sawtell",
      ...
      backing: "#e0f3f9",
      speed: 0.3,
      params: { count: 3, spread: 11, depth: 13, size: 1.1, tube: 0.18, drift: 0.9 },
    },
    {
      id: "p5",
      name: "Currarong",
      ...
      backing: "#e8f0ff",
      speed: 0.5,
      params: { count: 3, spread: 9, depth: 14, size: 0.95, tube: 0.14, drift: 1.1 },
    },
    {
      id: "p6",
      name: "Devils Marbles",
    ...
    },
    {
      ...
      backing: "#17110d",
      speed: 0.35,
      params: { count: 2, spread: 8, depth: 14, size: 1.3, tube: 0.24, drift: 0.7 },
    },
    {
      id: "p8",
      name: "Kings Canyon",
      ...
      backing: "#19100e",
      speed: 0.45,
      params: { count: 4, spread: 12, depth: 12, size: 0.85, tube: 0.12, drift: 1.25 },
    },
    {
      id: "p9",
      name: "Standley",
      ...
      backing: "#15101c",
      speed: 0.3,
      params: { count: 3, spread: 10, depth: 13, size: 1.05, tube: 0.18, drift: 0.9 },
    },
  ],
  "skyline-prisms": [
    {
      ...
      backing: "#e4f2fe",
      speed: 0.4,
      params: { count: 9, spread: 14, depth: 14, tallest: 8, drift: 1 },
    },
    {
      id: "p2",
      name: "Organ Pipes",
      ...
      backing: "#eaf0ff",
      speed: 0.35,
      params: { count: 12, spread: 17, depth: 16, tallest: 10, drift: 0.7 },
    },
    {
      id: "p3",
      ...
      backing: "#ddf5ef",
      speed: 0.45,
      params: { count: 7, spread: 12, depth: 13, tallest: 6, drift: 1.3 },
    },
    {
      id: "p4",
      name: "Glasshouse",
      ...
      backing: "#ddf6e7",
      speed: 0.3,
      params: { count: 10, spread: 15, depth: 15, tallest: 9, drift: 0.85 },
    },
    {
      id: "p5",
      name: "Hazards",
      ...
      backing: "#ffece8",
      speed: 0.5,
      params: { count: 8, spread: 13, depth: 14, tallest: 7, drift: 1.1 },
    },
    {
      id: "p6",
      name: "Three Sisters",
    ...
    },
    {
      ...
      backing: "#13101c",
      speed: 0.45,
      params: { count: 7, spread: 12, depth: 13, tallest: 6, drift: 1.2 },
    },
    {
      id: "p9",
