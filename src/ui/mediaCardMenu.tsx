...
/** The media-card ⋯/right-click menu (2026-07-12): shared by the media library, the Project-tab media drill-in and the Background ▸ Video picker. Edit opens the video editor (a rendered output reopens its own edit; an image opens as a freeze clip); the primary action is the host's ("Insert" pastes into Claude, "Select" picks); Delete is the house two-step to the Trash (refused while a scene or edit still references the file). Rename is deliberately absent for now (Michael's call). */
