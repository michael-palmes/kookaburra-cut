...
(https://openfontlicense.org); the full licence text is in [OFL.txt](./OFL.txt). Files are the fontsource latin-subset static
builds (woff), committed; the typeface JSONs
beside them are derived outline conversions (`pnpm assets:text3d-font`).

| Family | Files | Copyright |
| --- | --- | --- |
| Inter | Inter-Regular.*, Inter-SemiBold.woff | © The Inter Project Authors (rsms.me/inter) |
| Playfair Display | PlayfairDisplay-SemiBold.woff | © 2017 The Playfair Display Project Authors (github.com/clauseggers/Playfair) |
| Lora | Lora-Regular.woff | © 2011 The Lora Project Authors (github.com/cyrealtype/Lora-Cyrillic) |
