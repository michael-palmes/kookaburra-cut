...
/**
 * Preview Lab — preset still for the "contour-field" 3D background ("Diamantina"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
