...
/**
 * Preview Lab — preset still for the "contour-field" 3D background ("Dorrigo"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
