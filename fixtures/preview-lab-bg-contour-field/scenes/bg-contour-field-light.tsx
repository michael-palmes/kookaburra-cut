...
/**
 * Preview Lab — light-mode 3D background sample for "contour-field" ("Dorrigo"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
