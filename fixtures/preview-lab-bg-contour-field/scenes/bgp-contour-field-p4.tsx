...
/**
 * Preview Lab — preset still for the "contour-field" 3D background ("Liverpool Plains"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
