...
/**
 * Preview Lab — preset still for the "contour-field" 3D background ("Cooper Creek"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
