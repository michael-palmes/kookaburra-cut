...
/**
 * Preview Lab — preset still for the "grid-shell" 3D background ("Yamba"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
