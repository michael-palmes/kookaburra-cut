...
/**
 * Preview Lab — preset still for the "grid-shell" 3D background ("Marree"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
