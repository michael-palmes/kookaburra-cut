...
/**
 * Compare Spike scene 2: a STATIC 50:50 split. Two themes, two animated shader backgrounds
 * (u_linearOut must hold in BOTH offscreen targets), two device screens, hard vertical divider.
 * The comparison composition (the scaffolded template's shape); the compare block lives in the
 * sidecar.
 */
export default defineScene({
  id: "compare-transition-spike-split",
  durationMs: 1800,
  Scene() {
