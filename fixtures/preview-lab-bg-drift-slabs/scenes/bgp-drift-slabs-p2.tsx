...
/**
 * Preview Lab — preset still for the "drift-slabs" 3D background ("Balmoral"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
