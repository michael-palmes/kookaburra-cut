...
/**
 * Preview Lab — preset still for the "drift-slabs" 3D background ("Burleigh"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
