...
/**
 * Preview Lab — text-motion sample for the "word-cycle" preset. DEV-ONLY: rendered by
...
export default defineScene({
  id: "lab-tm-word-cycle",
  durationMs: 1600,
  Scene() {
    const format = useFormat();
    const portrait = format.aspect < 1;
    const headline = useSceneText("headline", "Fast. Simple. Yours.");
    return (
      <SceneStage>
        <AnimatedHeadline
          text={headline}
