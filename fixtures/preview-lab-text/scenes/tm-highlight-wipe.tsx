...
/**
 * Preview Lab — text-motion sample for the "highlight-wipe" preset. DEV-ONLY: rendered by
...
export default defineScene({
  id: "lab-tm-highlight-wipe",
  durationMs: 1600,
  Scene() {
    const format = useFormat();
    const portrait = format.aspect < 1;
    const headline = useSceneText("headline", "The new standard");
    return (
      <SceneStage>
        <AnimatedHeadline
          text={headline}
