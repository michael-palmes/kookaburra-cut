...
/**
 * Preview Lab — text-motion sample for the "underline-draw" preset. DEV-ONLY: rendered by
...
export default defineScene({
  id: "lab-tm-underline-draw",
  durationMs: 1600,
  Scene() {
    const format = useFormat();
    const portrait = format.aspect < 1;
    const headline = useSceneText("headline", "Now available");
    return (
      <SceneStage>
        <AnimatedHeadline
          text={headline}
