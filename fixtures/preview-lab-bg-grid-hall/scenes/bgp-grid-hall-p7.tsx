...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Yarrangobilly"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
