...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Margaret River"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
