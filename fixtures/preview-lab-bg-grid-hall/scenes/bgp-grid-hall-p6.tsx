...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Wombeyan"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
