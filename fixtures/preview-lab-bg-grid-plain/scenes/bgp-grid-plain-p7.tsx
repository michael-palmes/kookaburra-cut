...
/**
 * Preview Lab — preset still for the "grid-plain" 3D background ("Tanami"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
