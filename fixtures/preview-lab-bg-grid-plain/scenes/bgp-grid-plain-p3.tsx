...
/**
 * Preview Lab — preset still for the "grid-plain" 3D background ("Daylesford"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
