...
/**
 * Preview Lab — preset still for the "grid-plain" 3D background ("Pemberton"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
