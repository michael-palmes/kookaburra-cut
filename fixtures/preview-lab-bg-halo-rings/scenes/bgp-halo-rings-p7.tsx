...
/**
 * Preview Lab — preset still for the "halo-rings" 3D background ("Bungle Bungle"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
