...
/**
 * Preview Lab — light-mode 3D background sample for "orb-field" ("Moreton"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
