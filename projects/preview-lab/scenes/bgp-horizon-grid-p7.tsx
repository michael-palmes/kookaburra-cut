...
/**
 * Preview Lab — preset still for the "horizon-grid" fill ("Snowy Night"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
