...
/**
 * Preview Lab — preset still for the "halo-rings" 3D background ("Sawtell"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
