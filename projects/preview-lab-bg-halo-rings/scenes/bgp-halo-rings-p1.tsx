...
/**
 * Preview Lab — preset still for the "halo-rings" 3D background ("Wave Rock"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
