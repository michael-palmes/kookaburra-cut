...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Mole Creek"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
