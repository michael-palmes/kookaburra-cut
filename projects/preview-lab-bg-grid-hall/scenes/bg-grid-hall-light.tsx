...
/**
 * Preview Lab — light-mode 3D background sample for "grid-hall" ("Jenolan"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
