...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Capricorn Coast"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
