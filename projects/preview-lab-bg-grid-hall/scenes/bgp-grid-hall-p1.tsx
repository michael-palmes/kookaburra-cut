...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Jenolan"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
