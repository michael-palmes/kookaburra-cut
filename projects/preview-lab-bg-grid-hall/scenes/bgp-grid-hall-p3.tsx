...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Buchan"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
