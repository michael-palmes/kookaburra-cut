...
/**
 * Preview Lab — preset still for the "grid-hall" 3D background ("Abercrombie"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
