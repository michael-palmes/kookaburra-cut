...
/**
 * Preview Lab — preset still for the "grid-plain" 3D background ("Oodnadatta"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
