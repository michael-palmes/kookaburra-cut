...
/**
 * Preview Lab — preset still for the "point-swell" 3D background ("Snapper"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
