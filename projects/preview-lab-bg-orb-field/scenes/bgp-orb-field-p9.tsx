...
/**
 * Preview Lab — preset still for the "orb-field" 3D background ("Gosses Bluff"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
