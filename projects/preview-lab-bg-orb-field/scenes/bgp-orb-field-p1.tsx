...
/**
 * Preview Lab — preset still for the "orb-field" 3D background ("Moreton"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
