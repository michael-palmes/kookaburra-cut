...
/**
 * Preview Lab — preset still for the "orb-field" 3D background ("Catseye"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
