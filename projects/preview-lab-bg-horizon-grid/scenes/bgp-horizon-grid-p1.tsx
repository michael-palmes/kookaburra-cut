...
/**
 * Preview Lab — preset still for the "horizon-grid" fill ("Cable Beach"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
