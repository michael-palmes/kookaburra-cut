...
/**
 * Preview Lab — preset still for the "dust-drift" 3D background ("Parkes"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
