...
/**
 * Preview Lab — preset still for the "skyline-prisms" 3D background ("Glasshouse"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
