...
/**
 * Preview Lab — preset still for the "skyline-prisms" 3D background ("Frenchmans Cap"). DEV-ONLY: rendered by `pnpm kookaburra:run --action option-previews`
