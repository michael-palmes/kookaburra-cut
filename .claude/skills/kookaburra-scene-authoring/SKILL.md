...
9. **Preview, then look.** The app the user has open IS the preview: it live-reloads within about a second of any `.tsx` or sidecar save. Before declaring done, run the validation loop below, then capture a frame (see "Seeing your work") and look at it.
